                ...
                if env_value == 'test':
                    ...
                    for i in range (0,len(SID)):
                        ...
                        if sol_type == 'Payment URL':
                            ...
                            apireq=payment_url_req(baseURL, 
                                            apiUser, 
                                            apiPassword, 
                                            p12path, 
                                            CertPwd, 
                        ...
                        responses.append(apireq)
                        responses_xml.append(apireq.text)
    ...
    <SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
        ...
        <SOAP-ENV:Body>
            <ns2:mcsRequest xmlns:ns2="http://www.ipg-online.com/mcsWebService">
                <ns2:createStore>
                <ns2:store>
                        <ns2:storeID>{SID}</ns2:storeID>
                        <ns2:storeAdmin>
                            <ns2:id>{SID}</ns2:id>
                            <ns2:password>{storepass}</ns2:password>
                        </ns2:storeAdmin>
                        <ns2:mcc>{MCC}</ns2:mcc>
                        <ns2:legalName>{dba}</ns2:legalName>
                        <ns2:dba>{dba}</ns2:dba>
                        ...
                        <ns2:address>
                            <ns2:address1>{street}</ns2:address1>
                            <ns2:address2>{colony}</ns2:address2>
                            <ns2:zip>{CP}</ns2:zip>
                        ...
                        <ns2:terminal>
                            <ns2:terminalID>{TID}</ns2:terminalID>
                            <ns2:externalMerchantID>{MID}</ns2:externalMerchantID>
